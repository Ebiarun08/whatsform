            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav nav-items ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " aria-current="page" href="#">Try Demo <i
                    ...
                    <form class="d-flex nav-form" action="login.php" method="post">
            ...
            <div class="container">
                <div class="row justify-content-center mt-5">
                    <div class="col-lg-8  hero-heading">
                        <h1>Collecting responses in WhatsApp is
                            <span>100% free</span> and <span>without limits</span>
                        </h1>
